...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO `card` (trackno, cardname, name, fulladdress, cardno, phoneno, password, qty, productnumber, cvv_code) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
             ...
             GetSQLValueString($_POST['id'], "int"),
                       ...
                       GetSQLValueString($_POST['productnumber,'], "int"),
                       GetSQLValueString($_POST['cvv_code'], "int"));
mysql_select_db('mms');
  $Result1 = mysql_query($insertSQL) or die(mysql_error());
   }

  $insertGoTo = "insert3.php";
  if (isset($_SERVER['QUERY_STRING'])) {

    $name = ($_POST['name']);

      if (!empty($_POST['remember_payment'])) {
     ...
     <font color=silver size=5>Payment Details</font>
        <form method="post" name="form1" id="form1" action="<?php echo $editFormAction; ?>">
             ...
             <div class="form-group">
              <font color=silver size=3 face="nyala">Card Name:</font>
              <input type="CardName" name="cardnam" id="cardnam" required class="form-control1">
             </div>

            <div class="form-group">
              <font color=silver size=3 face="nyala">Name:</font>
              <input type="Name" name="name" value="<?php if(isset($_COOKIE["username"])) { echo $_COOKIE["username"]; } ?>" required  class="form-control1"></td>
            </div>
            ...
            <div class="form-group">
             <font color=silver size=3 face="nyala">Size:</font>
...
customers WHERE customers.email='mukhtarmahadisahabi@gmail.com'";
